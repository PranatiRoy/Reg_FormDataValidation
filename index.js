...
//   if(firstNameValid.style.display == 'block' && lastNameValid.style.display == 'block' && 
//   emailValid.style.display == 'block' && phoneValid.style.display == 'block' && 
//   zipCodeValid.style.display == 'block' && stateValid.style.display == 'block' &&
//   tnCInvalid.style.display == 'none'){
